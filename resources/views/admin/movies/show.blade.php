...
<div class="movie-detail-page">
    ...
    <div class="cartelera-header">
        <h2 class="cartelera-header__title">
            <a href="{{ url()->previous() }}" class="back-link">← Cartelera</a>
        </h2>
        <div class="cartelera-header__breadcrumb">
            <span>INICIO</span>
            <span class="breadcrumb-sep">/</span>
            <a href="{{ url()->previous() }}" class="breadcrumb-link">CARTELERA</a>
            <span class="breadcrumb-sep">/</span>
    ...
    <div class="movie-detail">
        ...
        <div class="movie-detail__poster-col">
            <div class="movie-detail__poster-wrap">
                <img
                    src="{{ $movie->image ? asset('storage/' . $movie->image) : 'https://placehold.co/560x780/222/555?text=Sin+imagen' }}"
                    alt="{{ $movie->title }}"
