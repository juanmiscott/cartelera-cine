<div class="filter-modal overlay" id="userFilterModal">
    <div class="modal modal--filter">
        ...
        <form class="modal__form" novalidate>
            ...
            <div class="form__group">
                <label class="form__label" for="filter_name">Nombre</label>
                <input type="text" id="filter_name" name="name" class="form__input" placeholder="Buscar por nombre" value="{{ request('name') }}" autocomplete="off">
            </div>

            <div class="form__group">
                <label class="form__label" for="filter_email">Email</label>
                <input type="text" id="filter_email" name="email" class="form__input" placeholder="Buscar por email" value="{{ request('email') }}" autocomplete="off">
            </div>

        </form>

        <div class="modal__actions">
            <button type="button" class="filter-cancel-button">Cancelar</button>
